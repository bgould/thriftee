...
import com.facebook.swift.parser.Objects;
import com.facebook.swift.parser.ImmutableList;

import java.io.IOException;
import java.util.Collections;
import java.util.List;

import static com.facebook.swift.parser.Preconditions.checkNotNull;;
...
public class ThriftMethod implements Visitable
{
            ...
            List<TypeAnnotation> annotations)
    {
        ...
        this.throwsFields = ImmutableList.copyOf(
          throwsFields == null ? Collections.emptyList() : throwsFields
        );
