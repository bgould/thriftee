...
Thrift.Protocol.prototype = {
    ...
    readString: function() {
        var r = this.readI32(); //, Base64 = this.Base64;
        //return r;
        return (typeof(r.value) === 'string') ? { value: atob(r.value) } : r;
        //console.log(typeof(r), r);
        //return (typeof(r.value) === 'string') ? { value: Base64.decode(r.value) } : r;
    },
