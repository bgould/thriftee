...
public class Generator {
	...
	private void init() throws IOException {
		...
		System.out.println("[Generator] final include map: " + includeMap);
		System.out.println("[Generator] final package map: " + packageMap);	
	}
	
	private Swift2ThriftGeneratorConfig createConfig(File _outputFile, String _packageName) {
		return Swift2ThriftGeneratorConfig.builder().
